...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<String> config = FileManager.stringReader("D:/SimuladorCacheOAC/SimuladorCache_AlexandreRodrigues/data/config.txt");
		...
		mapeamento.Direto();
		System.out.println("-----------------------------------------------------------------------");
		mapeamento.Associativo(op);
		System.out.println("-----------------------------------------------------------------------");
		mapeamento.AssociativoConjunto(op, tamCache);
	}
